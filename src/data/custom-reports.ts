      ...
      series: [
        {
          name: "Allowed",
          color: C.quaternary,
          values: [41.2e6, 43.8e6, 39.1e6, 45.6e6, 47.2e6, 44.9e6, 43.9e6],
        },
        {
          name: "Blocked",
          color: C.text,
          values: [68e3, 72e3, 64e3, 81e3, 79e3, 71e3, 65e3],
        },
        {
          name: "Threats",
          color: C.tertiary,
          values: [88e3, 94e3, 79e3, 112e3, 98e3, 91e3, 96e3],
        },
      ],
    },
    bar: {
      ...
      series: [
        {
          name: "Malware",
          color: C.tertiary,
          values: [32e3, 35e3, 29e3, 41e3, 36e3, 33e3, 35e3],
        },
        {
          name: "Phishing",
          color: C.pairingPurple,
          values: [26e3, 28e3, 24e3, 33e3, 30e3, 28e3, 29e3],
        },
      ],
    },
    bar: {
      ...
      series: [
        {
          name: "Threats",
          color: C.tertiary,
          values: [241300, 198400, 91200, 64800, 39200, 24110],
        },
      ],
    },
    pie: [
      ...
      series: [
        {
          name: "google.com",
          color: C.primary,
          values: [12.1e6, 13.4e6, 11.8e6, 14.2e6, 13.9e6, 13.1e6, 12.8e6],
        },
        {
          name: "microsoft.com",
          color: C.pairingTeal,
          values: [8.2e6, 8.9e6, 7.7e6, 9.4e6, 9.1e6, 8.6e6, 8.3e6],
        },
      ],
    },
    bar: {
      ...
      series: [
        {
          name: "Requests",
          color: C.primary,
          values: [92.1e6, 61.4e6, 48.9e6, 37.2e6, 29.8e6, 21.4e6],
        },
      ],
    },
    pie: [
      ...
      series: [
        {
          name: "j.martinez",
          color: C.primary,
          values: [580e3, 612e3, 540e3, 660e3, 640e3, 601e3, 588e3],
        },
        {
          name: "a.chen",
          color: C.pairingTeal,
          values: [510e3, 540e3, 480e3, 590e3, 570e3, 532e3, 519e3],
        },
      ],
    },
    bar: {
      ...
      series: [
        {
          name: "Requests",
          color: C.primary,
          values: [4.12e6, 3.68e6, 3.21e6, 2.84e6, 2.39e6, 1.92e6],
        },
      ],
    },
    pie: [
      ...
      series: [
        {
          name: "HQ — Austin",
          color: C.primary,
          values: [18.2e6, 19.4e6, 17.1e6, 20.6e6, 20.1e6, 18.9e6, 18.3e6],
        },
        {
          name: "Remote VPN",
          color: C.pairingTeal,
          values: [11.1e6, 12.2e6, 10.4e6, 13.1e6, 12.7e6, 11.9e6, 11.4e6],
        },
      ],
    },
    bar: {
      ...
      series: [
        {
          name: "Requests",
          color: C.primary,
          values: [128e6, 74e6, 52e6, 31e6, 14e6, 7.2e6],
        },
      ],
    },
    pie: [
      ...
      series: [
        {
          name: "Adult Content",
          color: C.tertiary,
          values: [19e3, 21e3, 18e3, 24e3, 22e3, 20e3, 18.1e3],
        },
        {
          name: "Gambling",
          color: C.pairingPurple,
          values: [12e3, 13e3, 11e3, 15e3, 14e3, 13e3, 12.4e3],
        },
      ],
    },
    bar: {
      ...
      series: [
        {
          name: "Blocked",
          color: C.text,
          values: [142100, 98400, 76200, 61800, 49200, 38700],
        },
      ],
    },
    pie: [
      ...
      series: [
        {
          name: "Default Block",
          color: C.primary,
          values: [24e3, 26e3, 22e3, 30e3, 28e3, 26e3, 24.2e3],
        },
        {
          name: "Security Hard",
          color: C.tertiary,
          values: [16e3, 17e3, 15e3, 20e3, 19e3, 17e3, 16.4e3],
        },
      ],
    },
    bar: {
      ...
      series: [
        {
          name: "Block Actions",
          color: C.primary,
          values: [184200, 121400, 78900, 54200, 38100, 23540],
        },
      ],
    },
    pie: [
...
export const SAMPLE_REPORTS: SavedReport[] = [
  {
    ...
    desc: "Blocked threats by classification",
    source: "Threats & Security Categories",
    chart: "bar",
  ...
  {
    id: 2,
    name: "Request Activity — 7 Day",
    desc: "Allowed / blocked / threats over time",
    source: "DNS Request Activity",
    chart: "line",
    schedule: "Daily · 6:00",
    lastRun: "Jun 1, 2026",
    owner: "DJ",
  ...
  {
    id: 3,
    name: "Blocked Content Breakdown",
    desc: "Blocked requests by content category",
    source: "Content Categories Blocked",
    chart: "pie",
    schedule: null,
    lastRun: "May 28, 2026",
    owner: "AC",
  ...
  {
    id: 4,
    name: "Top Talkers by Site",
    desc: "Traffic & protection by Site",
    source: "Sites / Networks",
    chart: "bar",
