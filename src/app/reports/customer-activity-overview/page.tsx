...
const TOP_WEBSITES: Row[] = [
  { nm: "portal.zorustech.com", val: "72h 59m", sub: "(57.4%)", pct: 100, users: "3 users" },
  { nm: "dnsfilter.atlassian.net", val: "21h 33m", sub: "(16.9%)", pct: 29.5, users: "1 user" },
  { nm: "docs.google.com", val: "8h 6m", sub: "(6.4%)", pct: 11.1, users: "2 users" },
  { nm: "mail.google.com", val: "4h 39m", sub: "(3.7%)", pct: 6.4, users: "2 users" },
  { nm: "meet.google.com", val: "3h 55m", sub: "(3.1%)", pct: 5.4, users: "1 user" },
  { nm: "zorustech.atlassian.net", val: "3h 19m", sub: "(2.6%)", pct: 4.5, users: "1 user" },
  { nm: "calendar.google.com", val: "3h 14m", sub: "(2.5%)", pct: 4.4, users: "1 user" },
  { nm: "portal-staging.zorustech.com", val: "2h 53m", sub: "(2.3%)", pct: 3.9, users: "1 user" },
  { nm: "www.lowes.com", val: "1h 49m", sub: "(1.4%)", pct: 2.5, users: "1 user" },
  { nm: "chatgpt.com", val: "1h 35m", sub: "(1.2%)", pct: 2.2, users: "1 user" },
];
...
const TOP_APPS: Row[] = [
  ...
  { nm: "Microsoft® Windows® Operating System", val: "1h 27m", pct: 2.7, users: "3 users" },
...
const TOP_STREAMING: Row[] = [
  { nm: "Google Chrome", val: "49h 10m", sub: "(74.8%)", pct: 100, users: "2 users" },
  ...
  { nm: "Snipping Tool", val: "<1m", sub: "(<0.1%)", pct: 0.3, users: "1 user" },
];

const TOP_AI: Row[] = [
  { nm: "Claude", val: "72h 59m", sub: "(31.0%)", pct: 100, users: "3 users" },
  { nm: "chatgpt.com", val: "65h 25m", sub: "(27.8%)", pct: 89.6, users: "3 users" },
  { nm: "GitHub Copilot", val: "48h 6m", sub: "(20.5%)", pct: 65.9, users: "2 users" },
  { nm: "Cursor", val: "30h 39m", sub: "(13.0%)", pct: 42, users: "2 users" },
  { nm: "perplexity.ai", val: "13h 55m", sub: "(5.9%)", pct: 19.1, users: "1 user" },
  ...
  return (
    <Box sx={{ mb: "20px" }}>
      ...
      >
        ...
        <Box
          component="span"
          sx={{ fontSize: 19, fontWeight: 600, whiteSpace: "nowrap", fontVariantNumeric: "tabular-nums" }}
        >
          {row.val}
          {row.sub && (
    ...
    >
      ...
      >
        {[
          ...
          >
            ...
            <Box
              sx={{ fontSize: 16, fontWeight: 600, letterSpacing: "1.5px", textTransform: "uppercase", color: TEXT2, mt: "12px" }}
            >
              {k.cap}
            </Box>
          </Box>
      ...
      <Box sx={{ mb: "72px" }}>
        ...
        >
          ...
          />
          <line x1="56" y1="238" x2="1245" y2="208" stroke={C.stream} strokeWidth="3" strokeDasharray="8 7" />
          <polyline
            fill="none"
            stroke={PRIMARY}
            strokeWidth="3.5"
        ...
        <Box sx={{ display: "flex", justifyContent: "center", gap: "32px", mt: "16px", fontSize: 16, color: TEXT2 }}>
          ...
          <Box sx={{ display: "flex", alignItems: "center", gap: "10px" }}>
            <Box sx={{ width: 28, height: 0, borderTop: `3px dashed ${C.stream}` }} />
            30-day trend
          </Box>
        </Box>
      </Box>
