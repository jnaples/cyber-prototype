// Report Manager → Library v4. The Library's original two-column design,
// restored from git: pick a report on the left, preview it on the right. Off
// the tab strip — reachable at /templates-v4.
...
export function ReportLibraryV4() {
