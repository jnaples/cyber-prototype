// Report Manager → Library v3. The Library's previous design, kept around for
// comparison: outlined report cards straight on the card's surface, with no
// neutral well behind them.
