    ...
    >
      {editing && (
        <IconButton
          ...
          onClick={onRemove}
          title="Remove"
          sx={{ position: "absolute", top: 6, right: 6, zIndex: 3, color: "error.main" }}
        >
